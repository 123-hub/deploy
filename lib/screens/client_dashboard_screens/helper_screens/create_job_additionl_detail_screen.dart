...
import 'package:flutter_project_labour_app/screens/client_dashboard_screens/components/contractor_job_dec_popup.dart';
...
class CreateJobAdditionalDetailsScreen extends StatelessWidget {
  CreateJobAdditionalDetailsScreen({super.key});
                ...
                child: NextButton(
                  ...
                  onPressed: () async {
                    if (contractorJobController.validateSecondPage()) {
                      contractorJobDescriptionPopUp(context, contractorJobController);
                    }
                  },
                ),
              )
