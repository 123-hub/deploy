...
import 'package:flutter_project_labour_app/screens/client_dashboard_screens/helper_screens/create_job_additionl_detail_screen.dart';
                ...
                children: [
                  ...
                  Obx(() {
                    return CreateJobTextField(
                      controller: contractorJobController.jobNameTextController,
                      hint: 'Enter Job Name',
                      errorText: contractorJobController.isJobNameValid.value
                          ? null
                  ...
                  Obx(() {
                    return CreateJobTextField(
                      controller: contractorJobController.jobTypeTextController,
                      hint: 'Enter Job Type',
                      errorText: contractorJobController.isJobTypeValid.value
                          ? null
                  ...
                  Obx(() {
                    return CreateJobTextField(
                      ...
                      hint: 'Enter location',
                      errorText: contractorJobController.islocationValid.value
                          ? null
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Obx(() {
                          return CreateJobTextField(
                            controller:
                                contractorJobController.durationTextController,
                            hint: 'Enter duration',
                            textInputType: TextInputType.number,
                            errorText:
                                contractorJobController.isdurationValid.value
                                    ? null
                        ...
                        child: Obx(() {
                          return DropdownButton<String>(
                            ...
                            items: ['days', 'months', 'years']
                                ...
                                .toList(),
                            onChanged: contractorJobController.changeDuration,
                          );
                        }),
                      )
                    ],
                    ...
                    child: NextButton(
                      ...
                      onPressed: () {
                        if (contractorJobController.validateFirstPage()) {
                          Get.to(() => CreateJobAdditionalDetailsScreen());
                        }
                      },
                    ),
                  ),
